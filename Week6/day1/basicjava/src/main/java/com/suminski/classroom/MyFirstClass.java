// always make sure to leave the package declaration at the top of your class file
// you don't technically need it, but you will quickly run into problems if you have more
// than one class
package com.suminski.classroom;


// the line of code below is the class declaration: this indicates that we have a class
// that will be working as a blueprint (potentially) for instantiating objects to run
// our code. There are a few things you need to declare a class:
